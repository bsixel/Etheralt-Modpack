...
// Prevent trampling farmland if falling from less than 2 blocks
events.onFarmlandTrample(function(event as crafttweaker.event.FarmlandTrampleEvent) {
	if (event.fallDistance < 2.0) {
		event.cancel();
	}
});*/
