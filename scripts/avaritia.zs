...
mods.compatskills.TileEntityLock.addTileEntityLock("minecraft:neutron_collector", "dim|-2");
mods.compatskills.Requirement.addRequirement(<avaritia:neutron_collector>, "dim|-2");
mods.compatskills.TileEntityLock.addTileEntityLock("minecraft:neutronium_compressor", "dim|-2");
mods.compatskills.Requirement.addRequirement(<avaritia:neutronium_compressor>, "dim|-2");
...
mods.avaritia.ExtremeCrafting.addShapeless("avaritia_catalyst_shapeless", <avaritia:resource:5>, [<avaritia:resource>, <avaritia:resource:1>, <avaritia:resource:2>, <avaritia:resource:3>, <avaritia:resource:4>, <avaritia:resource:7>, <avaritia:singularity>, <avaritia:singularity:1>, <avaritia:singularity:2>, <avaritia:singularity:3>,
	...
	<botania:storage:1>, <enderio:block_alloy_endergy:3>, <mekanism:basicblock:2>, <thermalfoundation:storage:7>, <taiga:vibranium_block>, <iceandfire:dragonsteel_fire_block>]);
